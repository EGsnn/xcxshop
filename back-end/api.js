...
module.exports = {
    ...
    // wx user login
    memberEnter: path + '/user/enter',
    


     // address
     addressList: path + '/address/my_address',
     addressDetail: path + '/address/detail',
     addressDelete: path + '/address/delete',
     addressAdd: path + '/address/add',
     addressDefault: path + '/address/default',
    ...
    orderPay: path + '/order/pay/get_prepayid',
    orderNotify: path + '/order/pay/notify',
	orderCancel: path + '/order/cancel',
	orderConfirm: path + '/order/confirm',
	orderRefund: path + '/order/refund',
    refundList:path + '/order/refund_list',//用户退款列表
    orderExpress:path + '/order/express',
